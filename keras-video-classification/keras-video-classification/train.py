...
H = model.fit(
	x=trainAug.flow(trainX, trainY, batch_size=5),
	steps_per_epoch=len(trainX) // 5,
	validation_data=valAug.flow(testX, testY),
	validation_steps=len(testX) // 5,
	epochs=epoch)

# evaluate the network
print("[INFO] evaluating network...")
predictions = model.predict(x=testX.astype("float32"), batch_size=5)
print("[INFO] Report...")
